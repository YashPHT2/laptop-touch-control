...
- **Live screen**: MJPEG stream, up to 30 FPS, adjustable
...
- **Joystick mode**: hold the stick for smooth, continuous cursor movement (great for gaming/design)
- **Gestures**: long-press = right click, double-tap = double click, press-and-drag = drag/select
- **Keyboard**: type with your phone keyboard + Esc/Tab/Enter/arrows/Ctrl+C/V/Z/Alt+Tab/Win+D
